...
REDIS_PORT=6379 cargo run > "${LOG_DIR}/app_6379.log" 2>&1 &
REDIS_PORT=6380 cargo run > "${LOG_DIR}/app_6380.log" 2>&1 &
REDIS_PORT=6381 cargo run > "${LOG_DIR}/app_6381.log" 2>&1 &
